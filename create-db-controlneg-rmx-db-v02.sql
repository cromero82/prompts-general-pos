-- BD v02 (Tienda Infinito): llega ya migrada (ver prompts-general-pos/CURSOR-IA-PC-TIENDA-V02.md).
...
--
-- Vacía (luego restaurar del dump ya migrado; ya no hay manifiesto de migración):
